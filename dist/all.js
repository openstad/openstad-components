...
var OpenStadComponentChoicesGuideResult = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  function OpenStadComponentChoicesGuideResult(props) {
    ...
    if (_this.config.submission.type == 'form') {
      // TODO: title? really?
      _this.onFormChange = _this.onFormChange.bind(_assertThisInitialized(_this));
      var allFormvalues = _libs_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].localStorage.get('osc-choices-guide.formvalues') || {};
      var formvalues = allFormvalues[_this.config.choicesGuideId] || {};

      _this.config.submission.form.fields.forEach(function (field) {
        if (typeof formvalues[field.title.toLowerCase()] != 'undefined') {
          field.value = formvalues[field.title.toLowerCase()];
        }
      });
    }
  ...
  _createClass(OpenStadComponentChoicesGuideResult, [{
    ...
    value: function submitResult() {
      ...
      if (errorState1 || errorState2) {
        self.setState(errorState1, function () {
      ...
      _fingerprintjs_fingerprintjs__WEBPACK_IMPORTED_MODULE_0__["default"].load().then(function (fp) {
        fp.get().then(function (result) {
          ...
          fetch(url, {
            ...
            if (self.config.submission.type == 'form') {
              _libs_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].localStorage.remove('osc-choices-guide.values');
              _libs_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].localStorage.remove('osc-choices-guide.scores');
              _libs_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].localStorage.remove('osc-choices-guide.formvalues');
    ...
    value: function onFormChange() {
      ...
      _libs_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].localStorage.set('osc-choices-guide.formvalues', allFormvalues);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      if (self.config.submission.type == 'form') {
        ...
        if (requireLogin) {
          if (self.isUserLoggedIn()) {
            ...
            if (self.state.submissionError) {
              _className = 'osc-error';
              _message = self.state.submissionError.message;
            }

            requireLoginHTML = /*#__PURE__*/React.createElement("div", {
              className: "osc-require-login osc-not-yet-logged-in ".concat(_className)
            }, /*#__PURE__*/React.createElement("h2", null, self.config.submission.requireLoginSettings.title), /*#__PURE__*/React.createElement("div", {
              className: "osc-gray-block"
              ...
              className: "osc-button osc-button-white"
            }, self.config.submission.requireLoginSettings.buttonTextLogin), /*#__PURE__*/React.createElement("div", {
              className: "osc-message"
            }, _message)));
          }
        }
...
var ChoiceForm = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  _createClass(ChoiceForm, [{
    ...
    value: function toggleEditMode(index) {
      this.setState({
        questionEditModeIndex: this.state.questionEditModeIndex != index ? index : null
      });
    }
  }, {
    key: "render",
    value: function render() {
      var self = this;
      var answers = self.props.currentTarget.answers;
      var answersHTML = /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement("strong", null, "Vraag")), /*#__PURE__*/React.createElement("div", {
        className: "osc-overview-line-content osc-overview-line-field"
      }, /*#__PURE__*/React.createElement("strong", null, "X")), self.props.currentTarget.questionGroup.answerDimensions > 1 && /*#__PURE__*/React.createElement("div", {
        className: "osc-overview-line-content osc-overview-line-field"
      }, /*#__PURE__*/React.createElement("strong", null, "Y")), /*#__PURE__*/React.createElement("div", {
        className: "osc-overview-line-buttons"
      }, /*#__PURE__*/React.createElement("div", {
        style: {
          width: '30px'
        }
      }))), Object.keys(self.props.currentTarget.questionGroup.questions).map(function (key, i) {
        var question = self.props.currentTarget.questionGroup.questions[key];
        var dimensions = [];
        var questionDimensions = question.dimensions || ['x'];
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "osc-overview-line-content"
        }, question.title, " (", question.id, ")"), dimensions.map(function (dimension, j) {
          var answerValue = self.props.currentTarget.answers && self.props.currentTarget.answers[question.id] && (_typeof(self.props.currentTarget.answers[question.id]) == 'object' ? self.props.currentTarget.answers[question.id][dimension] : self.props.currentTarget.answers[question.id]);

          if (self.state.questionEditModeIndex == i) {
            return /*#__PURE__*/React.createElement("div", {
              className: "osc-overview-line-content osc-overview-line-field",
              key: "field-".concat(j)
            }, /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
              config: {},
              value: answerValue,
              ...
              ref: function ref(el) {
                return self.questionImageBField = el;
              }
            }));
          } else {
            return /*#__PURE__*/React.createElement("div", {
      ...
      if (self.props.currentTarget.questionGroup && self.props.currentTarget.questionGroup.answerDimensions > 1) {
        imageHTML = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "Afbeelding"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].ImageUpload, {
          key: "i1",
          config: {
            as: 'json',
      ...
      }), imageHTML, /*#__PURE__*/React.createElement("h3", null, "Antwoorden"), answersHTML, /*#__PURE__*/React.createElement("h3", null, "Volgorde nummer"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
        config: {},
  ...
  _createClass(QuestionForm, [{
    ...
    value: function handleFieldChange(data) {
      ...
      if (data.questionImageA) {
        parsedData = {
          values: merge__WEBPACK_IMPORTED_MODULE_0___default.a.recursive({}, self.props.currentTarget.values)
        };
        var img = data.questionImageA;
      ...
      if (data.questionImageB) {
        ...
        var _img = data.questionImageB;

        try {
          _img = JSON.parse(_img);
        } catch (err) {}

        parsedData.values.B.questionImage = _img;
      }
      ...
      if (data.newValue) {
        parsedData = {
          values: self.props.currentTarget.values || []
        };
        parsedData.values.push(data.newValue);
        this.setState({
          valueEditModeIndex: parsedData.values.length - 1
        });
      }
      ...
      if (typeof data.valueIndex != 'undefined') {
        ...
        parsedData.values[data.valueIndex] = parsedData.values[data.valueIndex] || {
          text: '',
          value: {}
        };
        ...
        if (data.valueDimension) {
          if (typeof data.valueValue != 'undefined') {
            if (_typeof(parsedData.values[data.valueIndex].value) != 'object') parsedData.values[data.valueIndex].value = {};
    ...
    value: function toggleEditMode(index) {
      this.setState({
        valueEditModeIndex: this.state.valueEditModeIndex != index ? index : null
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      if (self.props.currentTarget.type == 'continuous') {
        valuesHTML = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "Label minimale waarde"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'input',
            minLength: 1,
            maxLength: 250
      ...
      if (self.props.currentTarget.type == 'a-to-b') {
        valuesHTML = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "Label bij A"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'input',
            minLength: 1,
            maxLength: 250
        ...
        }), /*#__PURE__*/React.createElement("h3", null, "Tekst bij A"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'input',
            minLength: 1,
            maxLength: 1000
          },
          value: self.props.currentTarget.values && self.props.currentTarget.values.A && self.props.currentTarget.values.A.questionText,
          onChange: function onChange(data) {
            return self.handleFieldChange({
              questionTextA: data.value
            });
          },
          ref: function ref(el) {
            return self.minLabelField = el;
          }
        }), /*#__PURE__*/React.createElement("h3", null, "Afbeelding bij A"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
          config: {},
          value: self.props.currentTarget.values && self.props.currentTarget.values.A && (_typeof(self.props.currentTarget.values.A.questionImage) == 'object' ? JSON.stringify(self.props.currentTarget.values.A.questionImage) : self.props.currentTarget.values.A.questionImage),
          onChange: function onChange(data) {
            return self.handleFieldChange({
              questionImageA: data.value
            });
          },
          ref: function ref(el) {
            return self.questionImageAField = el;
          }
        }), /*#__PURE__*/React.createElement("h3", null, "Label bij B"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'input',
            minLength: 1,
            maxLength: 250
        ...
        }), /*#__PURE__*/React.createElement("h3", null, "Tekst bij B"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'input',
            minLength: 1,
            maxLength: 1000
          },
          value: self.props.currentTarget.values && self.props.currentTarget.values.B && self.props.currentTarget.values.B.questionText,
          onChange: function onChange(data) {
            return self.handleFieldChange({
              questionTextB: data.value
            });
          },
          ref: function ref(el) {
            return self.minLabelField = el;
          }
        }), /*#__PURE__*/React.createElement("h3", null, "Afbeelding bij B"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
          config: {},
          value: self.props.currentTarget.values && self.props.currentTarget.values.B && (_typeof(self.props.currentTarget.values.B.questionImage) == 'object' ? JSON.stringify(self.props.currentTarget.values.B.questionImage) : self.props.currentTarget.values.B.questionImage),
          onChange: function onChange(data) {
            return self.handleFieldChange({
              questionImageB: data.value
            });
          },
          ref: function ref(el) {
            return self.questionImageBField = el;
      ...
      if (self.props.currentTarget.type == 'enum-buttons' || self.props.currentTarget.type == 'enum-radio') {
        valuesHTML = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "Opties"), /*#__PURE__*/React.createElement("div", {
          className: "osc-overview"
        }, /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-question-options"
        }, /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-line"
        }, /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-line-content"
        }, /*#__PURE__*/React.createElement("strong", null, "Tekst")), (self.props.currentTarget.dimensions == "['x']" || self.props.currentTarget.dimensions == "['x','y']") && /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-line-content osc-overview-line-field"
        }, /*#__PURE__*/React.createElement("strong", null, "X")), (self.props.currentTarget.dimensions == "['y']" || self.props.currentTarget.dimensions == "['x','y']") && /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-line-content osc-overview-line-field"
        }, /*#__PURE__*/React.createElement("strong", null, "Y")), /*#__PURE__*/React.createElement("div", {
          className: "osc-overview-line-buttons"
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }))), self.props.currentTarget.values && self.props.currentTarget.values.map(function (entry, i) {
          var showEntry = function showEntry(fieldname, dimension) {
            var value = dimension ? entry[fieldname][dimension] : entry[fieldname];

            if (self.state.valueEditModeIndex == i) {
              return /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
                config: {},
                value: value,
                onChange: function onChange(data) {
                  return self.handleFieldChange({
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            className: "osc-overview-line-content"
          }, showEntry('text')), (self.props.currentTarget.dimensions == "['x']" || self.props.currentTarget.dimensions == "['x','y']") && /*#__PURE__*/React.createElement("div", {
            className: "osc-overview-line-content osc-overview-line-field"
          }, showEntry('value', 'x')), (self.props.currentTarget.dimensions == "['y']" || self.props.currentTarget.dimensions == "['x','y']") && /*#__PURE__*/React.createElement("div", {
            className: "osc-overview-line-content osc-overview-line-field"
          }, showEntry('value', 'y')), /*#__PURE__*/React.createElement("div", {
            className: "osc-overview-line-buttons"
          }, /*#__PURE__*/React.createElement("a", {
            className: "osc-edit-button",
            onClick: function onClick(event) {
      ...
      var dimensionsHTML = null;

      if (self.props.currentTarget.questionGroup && self.props.currentTarget.questionGroup.answerDimensions > 1) {
        dimensionsHTML = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", null, "Deze vraag heeft invloed in de richting"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Select, {
          config: {
            choices: [{
              value: "['x']",
              description: "Alleen X"
            }, {
              value: "['y']",
              description: "Alleen Y"
            }, {
              value: "['x','y']",
              description: "X en Y"
            }]
      ...
      }), /*#__PURE__*/React.createElement("h3", null, "Afbeelding boven de vraag"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].ImageUpload, {
        key: "i1",
        config: {
          as: 'json',
          imageserver: self.config.imageserver
      ...
      }), /*#__PURE__*/React.createElement("h3", null, "Type vraag"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Select, {
        config: {
          choices: [{
            value: "continuous",
            ...
            value: "enum-radio",
            description: "multiple choice - radio"
          }]
        },
      ...
      }), valuesHTML, dimensionsHTML, /*#__PURE__*/React.createElement("h3", null, "Volgorde nummer"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].Text, {
        config: {},
        value: self.props.currentTarget.seqnr,
        onChange: function onChange(data) {
          return self.props.onChange({
...
var QuestionGroupForm = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  _createClass(QuestionGroupForm, [{
    ...
    value: function render() {
      ...
      }), /*#__PURE__*/React.createElement("h3", null, "Aantal dimensies voor antwoorden"), /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].Select, {
        config: {
          choices: [{
            value: "1",
            description: "1 - liniair"
          }, {
            value: "2",
            description: "2 - vlak"
          }]
        },
        value: self.props.currentTarget.answerDimensions,
        onChange: function onChange(data) {
          return self.props.onChange({
            answerDimensions: data.value
          });
        },
        ref: function ref(el) {
      ...
      if (this.selectedLocation) {
        if (this.selectedLocationMarker) {
          ...
          var icon = L.divIcon({
            ...
            iconAnchor: this.config.locationIcon.iconAnchor
          });
