...
/***/ "./src/reactions/component/osc-formelements/input-with-counter.jsx":
/*!*************************************************************************!*\
  !*** ./src/reactions/component/osc-formelements/input-with-counter.jsx ***!
  \*************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return OSCFormfieldsInputWithCounter; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
var OSCFormfieldsInputWithCounter = /*#__PURE__*/function (_React$Component) {
  _inherits(OSCFormfieldsInputWithCounter, _React$Component);

  var _super = _createSuper(OSCFormfieldsInputWithCounter);

  function OSCFormfieldsInputWithCounter(props) {
    var _this;

    _classCallCheck(this, OSCFormfieldsInputWithCounter);

    _this = _super.call(this, props);

    var self = _assertThisInitialized(_this);

    self.id = props.id || "osc--formfields-plaintext-with-counter-".concat(parseInt(1000000 * Math.random()));
    self.defaultConfig = {
      name: 'tekst',
      inputType: 'input',
      minLength: 5,
  ...
  _createClass(OSCFormfieldsInputWithCounter, [{
    key: "validate",
    value: function validate(settings) {
      ...
      if (settings && settings.showWarning) state.showWarning = true;
      this.setState(state);
    ...
    value: function render() {
      ...
      if (self.state.focused) {
        if (self.state.value.length < self.config.minLength) {
          ...
          counter = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "osc-form-counter ".concat(error)
      ...
      if (self.state.showWarning && self.state.warning) {
        warning = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          ...
          ref: function ref(el) {
            return _this3['form-warning-theme'] = el;
          }
        }, self.state.warning);
      }
  ...
  return OSCFormfieldsInputWithCounter;
}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component);
...
/* harmony import */ var _osc_formelements_input_with_counter_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./osc-formelements/input-with-counter.jsx */ "./src/reactions/component/osc-formelements/input-with-counter.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var OpenStadComponentReactionForm = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  function OpenStadComponentReactionForm(props) {
    ...
    self.id = props.id || "osc-reaction-form-".concat(parseInt(1000000 * Math.random()));
    self.defaultConfig = {
      argumentId: null,
      api: {
        url: null,
  ...
  _createClass(OpenStadComponentReactionForm, [{
    ...
    value: function handleOnChange(data) {
      data = data || {};
      if (data.description) data.isValid = this.description.validate();
      this.setState(data);
    }
  }, {
    key: "canSubmit",
    ...
    value: function submitForm() {
      ...
      self.setState({
        ...
        var headers = OSCLibs.api.getHeaders();
        ...
        fetch(url, {
          ...
          self.setState({
            ...
            if (self.config.argumentId) {
              var event = new CustomEvent('reactionEdited', {
                detail: json
              });
              document.dispatchEvent(event);
            } else {
              var _event = new CustomEvent('newReactionStored', {
                detail: json
              });
    ...
    value: function render() {
      ...
      if (self.canSubmit()) {
        ...
        submitButtonHTML = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          ...
          onClick: function onClick() {
            OSCLibs.localStorage.set('osc-reactions-login-pending', true);
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_osc_formelements_input_with_counter_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
var OpenStadComponentReaction = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  _createClass(OpenStadComponentReaction, [{
    ...
    value: function componentDidMount(prevProps, prevState) {
      var self = this;
      document.addEventListener('newReactionStored', function (event) {
        self.onNewReactionStored(event.detail);
      });
      document.addEventListener('reactionEdited', function (event) {
    ...
    value: function submitDelete() {
      ...
      fetch(url, {
        ...
        var event = new CustomEvent('reactionDeleted', {
          detail: {
    ...
    value: function render() {
      ...
      if (self.state.editMode) {
        descriptionHTML = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          className: "osc-reaction-description"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OSCReactionForm, {
      ...
      if (data.reactions && data.reactions.length) {
        repliesHTML = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
            key: key
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(OSCReaction, {
            config: self.config,
            className: "osc-reply",
            user: self.state.user,
            data: reaction
    ...
    value: function render() {
      ...
      var reactions = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: key
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(OSCReaction, {
          config: self.config,
          user: self.state.user,
      ...
      }, title, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(OSCReactionForm, {
        config: self.config,
        user: self.state.user
...
/* harmony import */ var _css_default_less__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_css_default_less__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _component_reactions_jsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component/reactions.jsx */ "./src/reactions/component/reactions.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _component_reactions_jsx__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Reactions", function() { return _component_reactions_jsx__WEBPACK_IMPORTED_MODULE_5__["default"]; });
...
_component_reactions_jsx__WEBPACK_IMPORTED_MODULE_5__["default"].renderElement = function renderElement(elem, config) {
  var attributes = elem.attributes;
  react_dom__WEBPACK_IMPORTED_MODULE_2___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_component_reactions_jsx__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
/******/ });
//# sourceMappingURL=reacrions.js.map