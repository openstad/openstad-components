...
/* harmony import */ var filepond_polyfill__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! filepond-polyfill */ "./node_modules/filepond-polyfill/dist/filepond-polyfill.js");
/* harmony import */ var filepond_polyfill__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(filepond_polyfill__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _default_input_jsx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./default-input.jsx */ "./src/forms/component/default-input.jsx");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
Object(react_filepond__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"])(filepond_plugin_image_preview__WEBPACK_IMPORTED_MODULE_2___default.a, filepond_plugin_file_validate_type__WEBPACK_IMPORTED_MODULE_3___default.a, filepond_plugin_file_validate_size__WEBPACK_IMPORTED_MODULE_4___default.a, filepond_plugin_file_poster__WEBPACK_IMPORTED_MODULE_5___default.a);
...
}(_default_input_jsx__WEBPACK_IMPORTED_MODULE_6__["default"]);
    ...
    value: function fetchData() {
      ...
      fetch(url, {
        ...
        self.setState({
          ...
          if (_libs_index_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].localStorage.get('osc-login-pending-scroll-to-reactions')) {
            document.getElementById('reactions') && document.getElementById('reactions').scrollIntoView();
            _libs_index_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].localStorage.set('osc-login-pending-scroll-to-reactions', false);
          }
        });
      })["catch"](function (err) {
...
/***/ "./src/reactions/component/not-logged-in-popup.jsx":
/*!*********************************************************!*\
  !*** ./src/reactions/component/not-logged-in-popup.jsx ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _component_index_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../component/index.jsx */ "./src/component/index.jsx");
/* harmony import */ var _libs_index_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../libs/index.jsx */ "./src/libs/index.jsx");
/* harmony import */ var _modal_popup_index_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modal-popup/index.jsx */ "./src/modal-popup/index.jsx");
...
var OpenStadComponentReactionForm = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  _createClass(OpenStadComponentReactionForm, [{
    ...
    value: function showPopup() {
      ...
      // dispatch an event
      var self = this;
      var event = new window.CustomEvent('osc-show-modal-popup', {
        detail: {
          title: 'Login om verder te gaan',
          text: 'Login om een argument te plaatsen, te reageren of een argument te liken',
          buttonAction: function buttonAction() {
            _libs_index_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].localStorage.set('osc-login-pending-scroll-to-reactions', true);
            _libs_index_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].localStorage.set('osc-login-pending-show-details', self.config.ideaId);
            document.location.href = _this.config.loginUrl;
          },
          buttonText: 'Inloggen'
        }
      });
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement(_modal_popup_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"], {
        ref: function ref(el) {
          return self.modalPopup = el;
        }
      });
    }
  }]);
...
var OpenStadComponentReactionForm = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  _createClass(OpenStadComponentReactionForm, [{
    ...
    value: function render() {
      ...
      if (self.canSubmit()) {
        inputHTML = /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          config: {
            inputType: 'textarea',
        ...
        inputHTML = /*#__PURE__*/React.createElement("div", {
          style: {
            position: 'relative'
          }
        }, /*#__PURE__*/React.createElement(_forms_index_jsx__WEBPACK_IMPORTED_MODULE_2__["default"].InputWithCounter, {
          disabled: true,
          config: {
            inputType: 'textarea',
            minLength: config.descriptionMinLength,
          ...
          onClick: function onClick() {
            return self.config.showNotLoggedInPopup();
          },
          style: {
            position: 'absolute',
            top: 0,
      ...
      return /*#__PURE__*/React.createElement("div", {
        id: self.divId,
        className: ""
      }, formIntro, inputHTML, submitButtonHTML);
    }
  }]);
...
/* harmony import */ var _not_logged_in_popup_jsx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./not-logged-in-popup.jsx */ "./src/reactions/component/not-logged-in-popup.jsx");
...
var OpenStadComponentReactions = /*#__PURE__*/function (_OpenStadComponent) {
  ...
  function OpenStadComponentReactions(props) {
    ...
    _this.showNotLoggedInPopup = _this.showNotLoggedInPopup.bind(_assertThisInitialized(_this));
    _this.state = {
  ...
  _createClass(OpenStadComponentReactions, [{
    ...
    key: "showNotLoggedInPopup",
    value: function showNotLoggedInPopup() {
    ...
    value: function render() {
      ...
      var reactions = /*#__PURE__*/React.createElement("ul", {
        ...
        return /*#__PURE__*/React.createElement("li", {
          ...
          config: _objectSpread(_objectSpread({}, self.config), {}, {
            showNotLoggedInPopup: self.showNotLoggedInPopup
          }),
          user: self.state.user,
      ...
      }, /*#__PURE__*/React.createElement(_not_logged_in_popup_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], {
        config: self.config,
        ref: function ref(el) {
          return self.notLoggedInPopup = el;
        }
