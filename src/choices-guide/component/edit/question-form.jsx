  ...
  render() {
    ...
    return (
      <div className="openstad-form">
        ...
        <h3>Titel</h3>
        <OpenStadComponentForms.InputWithCounter config={{ inputType: 'input', minLength: 0, maxLength: 200 }} value={self.props.currentTarget.title} onChange={ data => self.props.onChange({ title: data.value }) } ref={el => self.titleField = el}/>
        <h3>Beschrijving</h3>
        ...
        <OpenStadComponentForms.InputWithCounter config={{ inputType: 'textarea', minLength: 0, maxLength: 1000 }} value={self.props.currentTarget.moreInfo} onChange={ data => self.props.onChange({ moreInfo: data.value }) } ref={el => self.moreInfoField = el}/>
        ...
        <h3>Type vraag</h3>
        <OpenStadComponentForms.Select config={{ choices: [/*{ value: "continuous", description: "continue" }*/,{ value: "a-to-b", description: "van a naar b slider" },/*{ value: "enum-buttons", description: "multiple choice - buttons" }*/,{ value: "enum-radio", description: "radio buttons" }]  }} value={ self.props.currentTarget.type } onChange={ data => self.handleFieldChange({ type: data.value }) } ref={el => self.typeField = el}/>
